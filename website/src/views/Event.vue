...
<!--            <li class="nav-item"><router-link class="nav-link" :to="subLink('rosters')">Rosters</router-link></li>-->
            ...
            <li class="nav-item ct-passive" v-if="canEditEvent"><router-link class="nav-link" :to="subLink('editor')">Event Editor</router-link></li>
    ...
    computed: {
        ...
        canEditEvent() {
            ...
            return isEventStaffOrHasRole(this.$root.auth.user, {
                event: this.event,
                websiteRoles: ["Can edit any match"]
            });
        }
    },
    mounted() {
