  ...
  <div>
    ...
    >
      <b-alert show variant="warning">
        ...
        <p>
          Unfortunately, your browser doesn't support this feature! Try using Chrome instead (or a browser based on it
          like Edge).
        </p>
      </b-alert>
    ...
    <div v-else-if="appStatus === 'idle'">
      <b-alert show variant="secondary">
        Make sure Overwatch is closed during this!
      </b-alert>
      <p>
    ...
    <div v-else-if="appStatus === 'loaded'">
      <b-form-group label="Preset" v-slot="{ ariaDescribedby }">
        <b-form-radio-group
          v-model="action"
