<template>
    <div class="container">
        ...
        <table class="table table-sm table-dark table-bordered">
            ...
            <tr>
                <td>HeadToHead</td>
                <td>For 2 teams max - counts the matches aggregate (e.g. if they play each other once, it'll be 1 or -1.
            ...
            <tr>
                <td>MiniLeague</td>
                <td>Creates a standings of the matches for the opponents that are tied, and sorts them by match diff
                </td>
            </tr>
            <tr>
