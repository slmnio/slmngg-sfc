<template>
    <div class="match-score-reporting">
        ...
        existing: {{ existingScoreReport || 'n/a' }}
        ...
        <div v-else-if="scoreReportingEnabled" class="flex-center flex-column gap-4">
            ...
            <MatchEditor v-if="authStatus === 'team'" :match="match" :score-reporting="true" :hide-match-extras="true" />
...
export default {
    ...
    computed: {
        ...
        authStatus() {
            ...
            const controllableTeams = (this.teams || []).filter(team => [
                ...team.players || [],
                ...team.captains || [],
                ...team.team_staff || [],
                ...team.owners || [],
            ...
            console.log(controllableTeams);
            if (controllableTeams?.length) return "team";

            const editorPerm = canEditMatch(player, { event: this.match?.event, match: this.match });
            if (editorPerm) return "staff";
            return null;
        },
        steps() {
            const steps = [
