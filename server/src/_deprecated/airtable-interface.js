...
const tables = ["Broadcasts", "Clients", "Channels", "Discord Bots", "Players", "Live Guests", "Events", "GFX", "Event Series", "Teams", "Ad Reads", "Ad Read Groups", "News", "Matches",  "Themes",  "Socials", "Accolades", "Player Relationships", "Brackets", "Headlines", "Maps", "Map Data", "Heroes", "Log Files", "Tracks", "Track Groups", "Track Group Roles", "Trivia"];
...
function customUpdater(tableName, item) {
    ...
    if (tableName === "Clients" && item.key) Cache.set(`client-${item.key?.toLowerCase()}`, item);
