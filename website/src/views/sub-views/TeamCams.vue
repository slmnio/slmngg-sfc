<template>
    <div class="container">
        ...
        <ul>
            ...
            <li>
                The links may ask for audio, but we won't use it. We don't have team comms on stream, and you'll only
                be on stream in a clearly defined channel for interviews.
            </li>
            ...
            <li>
                You must be 16+ to use a webcam on a broadcast.
            </li>
        </ul>
        <h3>Cam links</h3>
