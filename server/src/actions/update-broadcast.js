...
export default {
    ...
    async handler({
        ...
        if (deskDisplayMode !== undefined) {
            let eligibleModes = [null, "Match", "Predictions", "Maps", "Notice (Team 1)", "Notice (Team 2)", "Notice (Event)", "Scoreboard", "Drafted Maps", "Interview", "Hidden", "Casters", "Scoreboard Bans"];
